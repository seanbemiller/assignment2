...
int main() {
	...
	vehiclesArray[6] = new Jet("Boeing", "747", "Rocket", 2);
	vehiclesArray[7] = new Jet("Airbus", "A50", "Gasoline", 3);
	vehiclesArray[8] = new Skateboard("Santa Cruz", "cruiser");
	vehiclesArray[9] = new Skateboard("Zero", "rider");
	vehiclesArray[10] = new Unicycle("Axis", "Beginner", 2);
	vehiclesArray[11] = new Unicycle("Coker", "Pro", 5);
